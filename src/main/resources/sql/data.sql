...
INSERT INTO users(username, password, enabled) VALUES ('user1', '$2a$10$DVg9RjwyIV9RzVZD9t82dejVx2RYlO/fBf5yJeyFzZuWHQA1uq/za', 1);
INSERT INTO users(username, password, enabled) VALUES ('user2', '$2a$10$KwYcWiGAUX3owaOECGmPHu6cGXo4XwWCvQeNE5WLLM/3M5de/i9fO', 1);
INSERT INTO users(username, password, enabled) VALUES ('admin', '$2a$10$aDmNiyH3Baf1opRdWNK8POLor0JwoQtBqG3dLZhgQG/am7RHWeMg.', 1);
